...
Cabe destacar que esta novela **es una secuela directa** del *anime* del mismo nombre ([disponible en Crunchyroll](https://www.crunchyroll.com/es-es/series/GG5H5X0Z8/tribe-nine)). Aunque no es obligatorio verlo, es **altamente recomendable**, pues los personajes y acontecimientos del mismo cobran relevancia en esta historia.
...
- ¿Cómo actualizo el parche?
  - Con instalarlo una vez, debería actualizarse automáticamente. Si no, reinstálalo manualmente cuando haya una actualización.

- Habéis lanzado un nuevo capítulo en español, ¿hay que actualizar el parche?
